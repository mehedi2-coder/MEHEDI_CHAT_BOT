(function(){
  const _0x64f3=[
    // =====================
    // Base64 এনকোডেড ক্যাপশন
    "4oCU4oCU4oCU4oCU4oCU4oCU4oCU4oCU4oCU4oCU",
  ...
  module.exports.config={
    ...
    description:"Random islamic reply with images when someone says Boot",
  ...
  module.exports.run=async function(_arg){
    try{
      ...
      const rIdx=_rand(_0x64f3.length-25);
